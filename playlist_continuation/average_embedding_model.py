...
minimum_playlist_inclusion = 50 # the minimum number of playlists a song has to be in to be considered for model output
playlist_subset = 1000000 # subset of playlist to train on - maximum of 1,000,000
...
for _, row in train_df.iterrows():
    ...
    if len(p_songs) >= (2 * k):
        ...
        print(len(np.concatenate(p_embeddings)))
